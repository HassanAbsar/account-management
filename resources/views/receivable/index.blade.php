...
@endsection
@section('button')
    <a type="button" class="btn btn-primary" href="{{ route('receivable.create') }}">
                ...
                <table id="example3" class="display" style="min-width: 845px">
                    ...
                    <thead>
                        <tr>
                            ...
                            <th><input type="text" id="search-customer" placeholder="Search Customer"></th>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form id="addPaymentForm" method="POST" action="{{ route('payments.storeInvoice') }}">
                        @csrf
                        <input type="hidden" name="receivable_id" id="invoice_id">
...
@push('custom_scripts')
    ...
    <script>
        var data = "{{ route('receivable.data') }}";
